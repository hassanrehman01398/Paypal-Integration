...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    private androidx.appcompat.widget.AppCompatImageView productImage;
    private ElegantNumberButton numberButton;
    private androidx.appcompat.widget.AppCompatTextView productPrice, productDescription, productName;
